...
#snap=['010','014','018','024','033'] #for batch runs
snap=['033']
...
for j in simulations:
    ...
    for k in snap:
        ...
        print('python', 'profiles_expand.py',prof1,prof2,prof3,prof4,prof5,prof6,prof7,prof8,prof9,prof10,k,sim,j,file=open(g,'a'))
        start=time.time()
